...
public class Alphabetizer{
    ...
    public Alphabetizer(List<Data> all_shifter) {
        List<Data> all_Alpha = all_shifter;
        Collections.sort(all_Alpha, new Comparator<Data>() {
            @Override
            public int compare(Data o1, Data o2) {
                if(o1.line==null&&o2.line==null){
                    throw new NullPointerException();
                }
                int num = 0;
                while(o1.line.charAt(num)==o2.line.charAt(num)){
                    num++;
                }
                int compareValue=0;
                char o1c=o1.line.charAt(num);
                char o2c=o2.line.charAt(num);
...
//        for (Data data:all_Alpha
//        ) {
//            System.out.println(data.line_row + " " +data.line);
//        }
    }
...
//    String ch = "Pipe and Filter " +
//            "pipe And filter";
//    Input in = new Input(ch);
//    MyShifter shifter = new MyShifter(All_Data.getData().all_input);
//    MyAlphabetizer pha = new MyAlphabetizer(All_Data.getData().all_Shifter);
//}
